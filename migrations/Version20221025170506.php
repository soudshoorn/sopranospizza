 ...
 */
final class Version20221025170506 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD status VARCHAR(255) NOT NULL, CHANGE price price DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP status, CHANGE price price INT NOT NULL');
